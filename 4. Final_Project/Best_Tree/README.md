...
- Best_tree shows the treefile and contree files that were created in iqtree after several unsuccessful attempts. The data can be found under Final_SM/SM_iqtree/trees as contree and treefile, along with the pictures that were generated by iqtree inside each file.
