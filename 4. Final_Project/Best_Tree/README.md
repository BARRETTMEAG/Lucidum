...
- The difference is shown when looking at the branches length, the Treefile branches show 10.0089 on the branch for Homo Sapiens, where the Contree branches a solid 10. Regardless of which tree, this number is large and  indicates multiple evoluationary changes. 
