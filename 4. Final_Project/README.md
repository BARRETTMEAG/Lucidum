...
Disclaimer:
 - Despite multiple attempts to group certain organisms in the same group and in a certain order, issues would arise in R, Beauti-Beast, and NGPhylogeny causing the trees to take incorrect shapes.
  ...
  - The trees in this final SM are the best attempts made, it may not be correct due multiple factors: the DNA sequences having errors, incomplete alignments, incorrect alignments, human errors, etc., despite attempts made to counterattack these situations, the trees still are not perfect.
